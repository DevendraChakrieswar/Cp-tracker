...
const fetchCodeforcesData = async (username) => {
    try {
        ...
        const successfulSubmissions = data.result.filter(submission => submission.verdict === 'OK');
...
module.exports = { fetchLeetCodeContestsData, fetchCodeforcesData, fetchCodeforcesContest, fetchAllUsersData};
